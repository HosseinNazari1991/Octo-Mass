...
namespace OctoMass
{
    public class OctoMassComponent : GH_Component
    {
        public OctoMassComponent()
          : base("Mass Generator", "MG",
            "Construct solid alternatives based on the inputs.",
            "OctoMass", "Mass Generator")
        {
        }
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("f2bf3006-d25d-4a23-badd-b0f68d2b9e36");
    }
}